      ...
      <div class="nxv2-tutorial-card">
        ...
        <div class="nxv2-tutorial-pages">
          ...
          <section hidden>
            ...
            <div class="nxv2-theme-grid">${(N.isGuest?[['modern','Modern']]:[['modern','Modern'],['fluent','Fluent'],['glass','Glass'],['minimal','Minimal'],['neon','Neon'],['liquid-glass','Liquid Glass']]).map(([x,label])=>`<button data-theme="${x}">${label}</button>`).join('')}</div>
